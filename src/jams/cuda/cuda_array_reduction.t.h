...
TEST(CudaArrayReductionTest, vector_field_reduce_cuda) {
  ...
  Vec<double, 3> cpu_result = jams::vector_field_reduce(x);
  Vec<double, 3> gpu_result = jams::vector_field_reduce_cuda(x);
...
TEST(CudaArrayReductionTest, vector_field_indexed_reduce_cuda) {
  ...
  Vec<double, 3> cpu_result = jams::vector_field_indexed_reduce(x, indices);
  Vec<double, 3> gpu_result = jams::vector_field_indexed_reduce_cuda(x, indices);
