...
private:
    ...
    jams::MultiArray<jams::Vec<std::complex<double>, 3>,1> calculate_static_structure_factor();
    jams::MultiArray<jams::Vec<std::complex<double>, 3>,2> periodogram();
    ...
    jams::MultiArray<jams::ComplexHi, 2> calculate_unpolarized_cross_section(const jams::MultiArray<jams::Vec<std::complex<double>, 3>,2>& spectrum);
    jams::MultiArray<jams::ComplexHi, 3> calculate_polarized_cross_sections(const jams::MultiArray<jams::Vec<std::complex<double>, 3>,2>& spectrum, const std::vector<jams::Vec<double, 3>>& polarizations);

    bool do_rspace_windowing_ = true;
    jams::MultiArray<jams::Vec<double, 3>, 1> rspace_displacement_;
    jams::MultiArray<jams::Vec<double, 3>, 1> kspace_path_;
    jams::MultiArray<jams::Vec<std::complex<double>, 3>,2>  kspace_spins_timeseries_;
    ...
    double kmax_ = 50.0;
    int num_k_ = 100;
    jams::Vec<double, 3> kvector_ = {0.0, 0.0, 1.0};
