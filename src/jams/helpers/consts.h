...
const double kNeutronGFactor        = 3.82608545; //               || NIST (https://physics.nist.gov)
const double kElementaryCharge      = 1.602176634e-19;  // C       || NIST (https://physics.nist.gov)
const double kElectronMass          = 9.1093837015e-31; // kg      || NIST (https://physics.nist.gov)
const double kSpeedOfLight          = 299792458.0;      // m s^-1  || NIST (https://physics.nist.gov)
