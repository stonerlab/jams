...
namespace jams {
    ...
    /// @param pbc jams::Vec<double, 3> of booleans for (a, b ,c), true if lattice direction is
    /// periodic
    /// @param r_i jams::Vec<double, 3> point i
    /// @param r_j jams::Vec<double, 3> point j
    ///
    /// @return interaction_vector_cart minimum image displacement
    ///
    jams::Vec<double, 3>
    minimum_image(const jams::Vec<double, 3> &a, const jams::Vec<double, 3> &b, const jams::Vec<double, 3> &c, const jams::Vec<bool, 3> &pbc,
                  const jams::Vec<double, 3> &r_i, const jams::Vec<double, 3> &r_j, const double& epsilon);
    ...
    ///
    jams::Vec<double, 3> minimum_image_bruteforce(const jams::Vec<double, 3> &a, const jams::Vec<double, 3> &b, const jams::Vec<double, 3> &c,
    ...
    /// @param r_i jams::Vec<double, 3> point i
    /// @param r_j jams::Vec<double, 3> point j
    /// @param offset_depth jams::Vec<double, 3> of integers giving the search +/- offset depth
    /// along (a, b, c)
    ///
    /// @return interaction_vector_cart minimum image displacement
    ///
    ...
    ///
    jams::Vec<double, 3> minimum_image_bruteforce_explicit_depth(const jams::Vec<double, 3> &a, const jams::Vec<double, 3> &b,
    ...
    /// @endcode
    ///
    jams::Vec<double, 3> minimum_image_smith_method(const jams::Vec<double, 3> &a, const jams::Vec<double, 3> &b, const jams::Vec<double, 3> &c,
                                    const jams::Vec<bool, 3> &pbc, const jams::Vec<double, 3> &r_i,
                                    const jams::Vec<double, 3> &r_j);
    ...
    /// condition.
    ///
    /// @param cell_matrix jams::Mat<double, 3, 3> where columns are (a, b, c) vectors defining the
    /// unit cell
    /// @param cell_inv_matrix jams::Mat<double, 3, 3> inverse of cell_matrix
    /// @param r_i jams::Vec<double, 3> point i
    /// @param r_j jams::Vec<double, 3> point j
    ///
    /// @return interaction_vector_cart minimum image displacement
    jams::Vec<double, 3> minimum_image_smith_method(const jams::Mat<double, 3, 3> &cell_matrix,
