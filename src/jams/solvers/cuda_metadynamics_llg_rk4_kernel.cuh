...
#ifndef JAMS_SOLVER_CUDA_METADYNAMICS_LLG_RK4_KERNEL_H
#define JAMS_SOLVER_CUDA_METADYNAMICS_LLG_RK4_KERNEL_H
...
__global__ void cuda_metadynamics_llg_rk4_combination_kernel
    (
        double * s_dev,
        const double * s_old,
        const double * k1_dev,
