...
//
// Positional material format:
// unitcell_pos_i unitcell_pos_j typename_i typename_j rx ry rz Jxx Jxy Jxz Jyx Jyy Jyz Jzx Jzy Jzz
//
enum class InteractionFileFormat {UNDEFINED, JAMS, KKR, POSITIONAL_MATERIAL};
