...
//     int i, const jams::Vec<double, 3> &spin_initial, const jams::Vec<double, 3> &spin_trial) {
//
...
private:
    ...
    int cached_i_ = -1;
    jams::Vec<double, 3> cached_spin_initial_ ;
    jams::Vec<double, 3> cached_spin_trial_;

protected:
    inline bool cache_is_initialised() const;

    inline bool can_use_cache_values(int i, const jams::Vec<double, 3> &spin_initial,
                                     const jams::Vec<double, 3> &spin_trial) const;

    inline double cached_value();

    inline void
    set_cache_values(int i, const jams::Vec<double, 3> &spin_initial, const jams::Vec<double, 3> &spin_trial,
...
public:
    ...
    inline void spin_move_accepted(int i, const jams::Vec<double, 3> &spin_initial,
                            const jams::Vec<double, 3> &spin_trial) override;
