...
double jams::CVarTopologicalCharge::local_topological_charge(const Vec<double, 3>& s_i, const Vec<double, 3>& s_j, const Vec<double, 3>& s_k) const {
...
double jams::CVarTopologicalCharge::local_topological_charge(const Triplet &t) const {
  Vec<double, 3> s_i = montecarlo::get_spin(t.i);
  Vec<double, 3> s_j = montecarlo::get_spin(t.j);
  Vec<double, 3> s_k = montecarlo::get_spin(t.k);
...
double jams::CVarTopologicalCharge::topological_charge_difference(int index,
  ...
  for (const auto& n : adjacent_triangles_[index]) {
    ...
    Vec<double, 3> s_i = t.i == index ? spin_initial : jams::montecarlo::get_spin(t.i);
    Vec<double, 3> s_j = t.j == index ? spin_initial : jams::montecarlo::get_spin(t.j);
    Vec<double, 3> s_k = t.k == index ? spin_initial : jams::montecarlo::get_spin(t.k);
