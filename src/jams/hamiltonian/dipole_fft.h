...
private:
    ...
    jams::MultiArray<jams::Complex, 5> generate_kspace_dipole_tensor(int pos_i, const int pos_j, std::vector<Vec<double, 3>>& generated_positions);
    ...
    std::vector<std::vector<jams::MultiArray<jams::Complex, 5>>> kspace_tensors_;
