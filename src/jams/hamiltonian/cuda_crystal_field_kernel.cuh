...
// C_{4,-3} Z_{4,-3}
      energy += dev_cf_coeffs[6*num_spins + idx] * 2.091650066335189*(sx*sx*sx - 3.*sx*(sy*sy))*sz;
...
// C_{4,3} Z_{4,3}
      energy += dev_cf_coeffs[12*num_spins + idx] * 2.091650066335189*(sx*sx*sx - 3.*sx*(sy*sy))*sz;
...
// C_{6,-5} Z_{6,-5}
      energy += dev_cf_coeffs[15*num_spins + idx] * 2.3268138086232857*(sx*sx*sx*sx*sx - 10.*(sx*sx*sx)*(sy*sy) + 5.*sx*(sy*sy*sy*sy))*sz;
...
// C_{6,5} Z_{6,5}
      energy += dev_cf_coeffs[25*num_spins + idx] * 2.3268138086232857*(sx*sx*sx*sx*sx - 10.*(sx*sx*sx)*(sy*sy) + 5.*sx*(sy*sy*sy*sy))*sz;
