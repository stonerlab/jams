...
public:
    ...
    virtual jams::Vec<jams::Real, 3> local_field(const jams::Real& time, const jams::Vec<jams::Real, 3>& r) = 0;
    virtual jams::Vec<jams::Real, 3> max_field(const jams::Real& time) = 0;
};
