...
class CudaDipoleBruteforceHamiltonian : public Hamiltonian {
    public:
        ...
        jams::Real calculate_one_spin_energy(const int i, const Vec<double, 3> &s_i, jams::Real time);
        ...
        Vec<jams::Real, 3>   calculate_field(const int i, jams::Real time) override;
